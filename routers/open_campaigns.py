        ...
        "campaigns": [
            {
                ...
                "platforms": c.platforms or ["instagram"],
                "content_types": c.content_types or ["post"],
...
async def get_open_campaign(
    ...
    return {
        ...
        "platforms": campaign.platforms or ["instagram"],
        "content_types": campaign.content_types or ["post"],
